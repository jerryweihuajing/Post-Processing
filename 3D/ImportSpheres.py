# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 14:32:24 2019

@author: Wei Huajing
@company: Nanjing University
@e-mail: jerryweihuajing@126.com

@title：Import Spheres
"""
...
def SamplePos(case_path):
    ...
    #path of sample
    sample_path=case_path.split('Data')[0]+'Data\\sample.txt'
...
def AllProgressPos(case_path):
    ...
    file_names=PP.FilePathsThisCase(case_path)
...
def GenerateSpheresMapWithSample(case_path):
    ...
    file_paths=PP.FilePathsThisCase(case_path)
...
#        print(len(lines_this_progress),len(spheres_pos_last_progress))
            
        #exception
        if len(lines_this_progress)<len(spheres_pos_last_progress):
